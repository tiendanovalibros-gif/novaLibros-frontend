...
export const inputFocusOn  = (e: React.FocusEvent<HTMLInputElement | HTMLSelectElement>, hasError: boolean) => {
  if (!hasError) e.target.style.borderColor = colors.primary;
};
export const inputFocusOff = (e: React.FocusEvent<HTMLInputElement | HTMLSelectElement>, hasError: boolean) => {
