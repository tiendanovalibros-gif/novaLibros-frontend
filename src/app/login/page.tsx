    ...
    <div style={{ ...S.root, fontFamily: "'DM Sans', 'Segoe UI', sans-serif" }}>
      ...
      <div style={S.leftPanel} className="login-left-panel">
        ...
        <div style={{ ...logoRow, position: 'relative', zIndex: 1 }}>
          <div style={logoBox}><BookIcon /></div>
        ...
        <div style={S.formWrapper}>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div style={S.forgotRow}>
              <a href="/forgot-password" style={S.forgotLink}>¿Olvidaste tu contraseña?</a>
            </div>
          ...
          <p style={S.bottomText}>
            ¿No tienes cuenta?{' '}
            <a href="/register" style={S.bottomLink}>Regístrate gratis</a>
          </p>
        </div>
      </div>
