...
import BookRegister from "@/components/book/book-register";
import {
...
type DialogMode = "edit" | "view" | "delete" | null;
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
          ...
          <div className="flex gap-3">
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 border border-slate-300 rounded-lg text-sm font-semibold text-slate-700 hover:bg-slate-50 transition-colors"
            >
              <Iconify icon="mdi:package-variant" className="text-slate-400" />
        ...
        <Modal title="Eliminar libro" onClose={cerrar}>
          <div className="flex flex-col items-center text-center gap-4 py-4">
            <div className="w-14 h-14 bg-red-50 rounded-full flex items-center justify-center">
              <Iconify icon="si:alert-duotone" className="text-red-500" width={40} />
            </div>
            <div>
